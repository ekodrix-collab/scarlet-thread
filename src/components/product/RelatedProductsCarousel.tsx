...
const products = [
  {
    ...
    rating: 4.9,
    reviews: 125,
    imagePlaceholder: "Dad Hoodie Blue",
    badge: "Bestseller"
  },
  {
    id: 102,
    ...
    rating: 4.8,
    reviews: 95,
    imagePlaceholder: "Dad Hoodie Black",
    badge: null
  },
  {
    id: 103,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 112,
    imagePlaceholder: "Black T-Shirt",
    badge: null
  }
]
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-heading font-bold flex items-center justify-center gap-2">
            You May Also Like <Heart className="w-5 h-5 text-primary fill-transparent" />
          </h2>
        </div>
          ...
          <div className="flex overflow-x-auto gap-6 pb-8 pt-4 px-2 snap-x hide-scrollbar">
            {products.map((product) => (
              <Card key={product.id} className="min-w-[260px] max-w-[280px] shrink-0 snap-start overflow-hidden border-border/50 shadow-sm hover:shadow-md transition-all group flex flex-col h-full rounded-2xl">
                <div className="relative aspect-square bg-[#FAFAFA] p-0 overflow-hidden">
                  ...
                  {/* Badges */}
                  {product.badge && (
                    <div className="absolute top-3 left-3 bg-white px-2 py-1 rounded border border-border shadow-sm text-[10px] font-bold uppercase tracking-wider text-primary">
                      {product.badge}
                    </div>
                  )}
                ...
                <CardContent className="p-4 pt-5 flex-1 flex flex-col">
                  ...
                  <div className="font-bold text-sm mb-3 text-primary">AED {product.price}</div>
