...
export function CraftedGalleryHer() {
  ...
  return (
    <section className="py-16 bg-[#FAFAFA] overflow-hidden">
      <motion.div initial={{ opacity: 0, scale: 1.05 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 1.2, ease: "circOut" }} className="container px-4 sm:px-6 md:px-12 lg:px-24">
