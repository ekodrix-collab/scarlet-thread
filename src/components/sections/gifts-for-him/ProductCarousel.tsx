      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-heading font-bold flex items-center justify-center gap-2">
            Most Loved Gifts For Him <Heart className="w-5 h-5 text-primary fill-transparent" />
          </h2>
          <p className="text-muted-foreground mt-2">Handpicked gifts that he will truly appreciate</p>
        </div>
              ...
              <Card key={product.id} className="min-w-[260px] max-w-[280px] shrink-0 snap-start overflow-hidden border-border/50 shadow-sm hover:shadow-md transition-all group flex flex-col h-full rounded-2xl">
                <div className="relative aspect-square bg-secondary/30 p-4">
                  ...
                  <div className="w-full h-full bg-white rounded-xl shadow-sm flex items-center justify-center border border-border/30 overflow-hidden relative">
                    <span className="font-heading italic text-2xl text-primary font-medium">{product.imagePlaceholder}</span>
                  </div>
                </div>
